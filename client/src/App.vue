      ...
      <p class="header-text">Welcome to Progressor.cx! Try now. <a>    <router-link style="color:white;"  @click="closeMenu" to="/apply">Click Here try Progressor.cx</router-link></a></p>
        ...
        <div class="header-content container mx-auto flex justify-between items-center">
          <router-link @click="closeMenu" to="/">
            <img alt="Logo" src="./assets/logo_clean.png" class="max-w-xs logo r3r3" style="height: 30px;" @click="navigateToHome" />
          </router-link>
          <router-link @click="closeMenu" style="text-decoration: none;" to="/home2">
           <a class="header_link">What</a>
          </router-link>
          <router-link   @click="closeMenu" style="text-decoration: none;" to="/landing">
           <a class="header_link">Why</a>
          </router-link>
          <router-link  @click="closeMenu" style="text-decoration: none;" to="/privacy">
  ...
  export default {
    ...
    data() {
      return {
        ...
        isDropdownVisible: {
          aboutus: false,
          contactus: false,
          // Add other menu buttons with their respective boolean values
        },
      };
    },
    ...
    methods: {
      ...
      if (this.activeDropdown === menu) {
        ...
        this.activeDropdown = menu; // Open the clicked dropdown
      }
    }, scrollToTop() {
      ...
      navigateToHome() {
        // Code to handle navigation to the home page
      },
      ...
      handleScroll() {
        ...
        if (scrollY > triggerHeight) {
          ...
          // Hide other dropdowns here if needed
        }
      },
    },
    watch: {
...
/* Adjust the header-text margin to make space for the swiggly border */
.header-text {
  font-size: 18px;
  font-weight: bold;
  color: #fff;
  margin: 0;
  margin-bottom: 15px; /* Added margin to create space for the border */
