...
<template>
  <div id="master">
    <header
      ...
      :style="{
        boxShadow:
          menuOpen2 === false || menuOpen === false
    ...
    >
      ...
      <div class="id_2s">
        ...
        <div v-if="$root.user && $root.tokens != 0" style="font-size: 11px">
          <router-link to="/chat2">GOTO CHAT</router-link>
        </div>
        ...
        <button
          @click="
            ...
            menuOpen = false;
          "
          class="colorlessbtn logo"
        >
          Company {{ !menuOpen2 ? "↓" : "↨" }}
        </button>
        <button
          v-if="!user"
          @click="$router.push('/pricing'), closeMenu"
          class="colorlessbtn"
        >
          Pricing
        </button>
        ...
        <div class="btn_holder">
          ...
          <button
            v-if="user"
            @click="$router.push('/welcome'), closeMenu"
            class="actionBTN2"
          >
            Account
          </button>
      ...
      >
        ...
        <a
          ...
          style="
            ...
            margin-left: 40px;
          "
          >Tokens: <a style="font-size: 20px">∞</a></a
        >
