<template>
  ...
  />
      ...
      <button style="background-color: #3b6bbd;" @click="renewSubscription">Renew Subscription</button>
      <button  style="background-color: #6e4a83;" @click="upgradeSubscription">Upgrade Subscription</button>
      <button   style="background-color: #9b2c4e;"  @click="manageBilling">Manage Billing</button>
      <button  style="background-color: rgb(180 29 51);" @click="viewUsage">View Usage</button>
  ...
  methods: {
    async viewUsage() {
      try {
        ...
        this.chartData.datasets[0].data = this.usageInfo.map((usage) => usage.tokensUsed);
