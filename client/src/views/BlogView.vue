<template>
  <div class="blog-container">
    ...
    <div class="main" v-else>
      ...
      <h1 class="blog-title" v-if="blog" style="margin-top: 10px">
        {{ blog.title }}
      </h1>
      <a v-else
        ><br />Sorry this blog has either been removed or deleted No blog found.
        Please</a
      >
      <p v-if="blog" class="blog-content" v-html="blog.content"></p>
      <!-- <br> -->
      <!-- <p v-if="blog" class="blog-content">{{ blog.read_count }} Views</p>
      <router-link :to="'/all_blogs'">View a
        ll Blogs</router-link> --><br />
...
.loading-overlay {
  ...
  background-color: rgba(
    ...
    255,
    0.9
  ); /* Use rgba for opacity transition */
  display: flex;
