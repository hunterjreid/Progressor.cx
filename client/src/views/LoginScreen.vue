<template>
  <div class="centered-content">
    <h1 style="    font-family: 'M PLUS 1 Code', monospace !important; font-size: 4em;margin: 0;">Log in</h1>
    ...
    <div v-if="!user"  style="width: 100%;margin-bottom: 10px;">
      <form @submit.prevent="emailPasswordSignIn">
        ...
        <button style="background-color: black;margin-left: 30px;" type="submit">Log in</button>
